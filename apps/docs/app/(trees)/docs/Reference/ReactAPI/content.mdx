...
The React entry point lives in `@baguette-studios/trees/react`. It is a thin
React integration layer over the same imperative model the vanilla runtime uses.
